...
{
    public class PostController : System.Web.UI.UserControl
    {
        ...
        public PostController(PostRepository postControl, PostValidator validator)
        {
            _postRepository = postControl;
        ...
        {
            var summary = GetErrorSummaryController();
        ...
        private BulletedList GetErrorSummaryController() => (BulletedList)FindControl("ErrorSummary");
        private Label GetErrorLabel(ValidationError error) => FindControl(error.PropertyName + "Error") as Label;
